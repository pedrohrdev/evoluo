...
// Extraído de app/c/[challengeId]/analytics/page.tsx para ser reaproveitado
// também na visão somente-leitura das análises de outro participante
// (app/profiles/[id]/challenges/[challengeId]/analytics) — parametrizado
// por participantId em vez de depender de useChallenge().
export function AnalyticsView({ participantId }: { participantId: string }) {
    ...
    <>
      ...
      {!isLoading && filtered.length === 0 ? (
        <EmptyState
          ...
          description="Assim que houver registros para este filtro, as análises aparecem aqui."
        />
      ) : null}
